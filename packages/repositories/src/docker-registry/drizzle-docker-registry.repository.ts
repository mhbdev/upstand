...
export class DrizzleDockerRegistryRepository
  extends BaseRepository<typeof dockerRegistry, DockerRegistry, CreateDockerRegistryDTO>
  implements IDockerRegistryRepository
{
  ...
  async findByOrganizationId(organizationId: string): Promise<DockerRegistry[]> {
