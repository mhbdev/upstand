...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Cookie Store is not available in every supported browser; this is the synchronous fallback.
      // biome-ignore lint/suspicious/noDocumentCookie: Sidebar state is a non-sensitive client preference.
