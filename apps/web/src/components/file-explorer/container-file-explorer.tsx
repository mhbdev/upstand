...
export function ContainerFileExplorer({
  ...
  const deleteItemMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      if (selectedFilePath && deleteConfirmItem && selectedFilePath === deleteConfirmItem.path) {
  ...
  return (
    <div className="flex h-[750px] w-full flex-col overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          {containersData.length > 0 && (
            ...
            >
              <SelectTrigger
                size="sm"
                className="h-8 border-input bg-background font-medium text-xs text-foreground"
              >
          ...
          <div className="space-y-2 border-border/50 border-b bg-muted/20 p-3">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-8 bg-background pl-8 font-mono text-xs text-foreground"
              />
            </div>
          </div>
              ...
              <div className="relative flex-1 overflow-hidden">
                {isReadingFile ? (
                  ...
                  <textarea
                    ...
                    className="h-full w-full resize-none border-none bg-background p-4 font-mono text-foreground text-xs leading-relaxed selection:bg-primary/20 outline-none focus:ring-0"
            ...
            <div className="flex h-full flex-col items-center justify-center gap-3 p-8 text-center text-muted-foreground">
              ...
              <div className="space-y-1">
                ...
                <p className="max-w-sm text-xs">
                  ...
                  rename, upload, or create new files inside your container volume.
                </p>
              </div>
            </div>
          )}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                renameItemMutation.isPending || !newRenamePath.trim()
              }
            >
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="font-mono text-sm text-amber-500">
              Unsaved Changes
            </DialogTitle>
            <DialogDescription className="text-xs">
