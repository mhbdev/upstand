...
- **IP Allowlisting & Geo-Blocking**: Block or restrict route access based on client IP CIDR ranges or Cloudflare country headers (`{http.request.header.CF-IPCountry}`).
