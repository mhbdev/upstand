...
2. Enter the model identifier supported by that provider. For OpenRouter, use **Load models** to fetch the current catalog; custom model IDs are also accepted.
